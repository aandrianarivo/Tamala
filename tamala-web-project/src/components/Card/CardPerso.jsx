export default function CardPerso() {
  return (
    <div className="card-perso m-5 w-10/12 h-full flex p-6">
      <div className="header-content w-2/4 bg-gray-50 p-6">
        <h3 className="text-bold text-gray-900/90 ">Our mission 2</h3>
        <h2 className="py-8 text-gray-500">#PILLAR 2</h2>
